...
import { interceptorTests } from './tests/interceptorTests.js'
import { driverTests } from './tests/driverTests.js'
import { errorHandlingTests } from './tests/errorHandlingTests.js'
...
export const testConfiguration = {
	...
	coverage: 'HTTP methods, content types, retries, backoff strategies, interceptors, timeouts'
}